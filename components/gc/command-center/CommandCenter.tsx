  ...
  const tabButtonClass = (tab: 'overview') =>
    `px-4 py-2 text-sm font-medium transition-colors border-b-2 ${
      activeTab === tab
        ...
        : `border-transparent ${isDarkMode ? 'text-slate-400 hover:text-slate-300' : 'text-slate-500 hover:text-gray-700'}`
    }`;
                ...
                <table className="w-full text-sm">
                  <thead>
                    ...
                    >
                      ...
                      <th className={`text-right py-2 font-medium ${textSecondary}`}>
                        Avg/Customer
                      </th>
                    </tr>
                  </thead>
