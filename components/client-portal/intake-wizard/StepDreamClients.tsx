...
interface StepDreamClientsProps {
  entries: ClientEntry[];
...
const StepDreamClients: React.FC<StepDreamClientsProps> = ({ entries, onChange }) => {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 dark:text-zinc-400 mb-6">
        Paste LinkedIn URLs of 3-5 people or companies that would be your dream clients. We'll use
        these to target your outreach.
      </p>
          ...
          return (
            <div key={index} className="rounded-lg border border-zinc-200 dark:border-zinc-800 p-4">
              ...
              <div className="ml-8 mt-2">
                ...
                >
                  {expandedNotes.has(index) ? 'Hide notes' : 'What makes them ideal?'}
                </button>
                {expandedNotes.has(index) && (
                  <textarea
                    ...
                    rows={2}
                    placeholder="e.g. They're a fast-growing agency, fit our ICP perfectly, high-ticket buyer..."
...
export default StepDreamClients;
